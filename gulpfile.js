...
function imgCopy(done) {
  ...
  gulp.src(paths.imgJPG.src).pipe(gulp.dest(paths.imgJPG.dest));
...
const watch = () => {
  ...
  gulp.watch(
    paths.img.src.concat(paths.imgJPG.src),
    gulp.series(imgCopy, reload)
  );
...
gulp.task(
  'watch',
  gulp.series(clean, scripts, styles, html, imgCopy, serve, watch)
);
